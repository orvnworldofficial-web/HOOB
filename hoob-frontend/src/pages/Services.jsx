  ...
  body: JSON.stringify({ email }),
          ...
          if (res.ok) {
            ...
            try {
              ...
              if (data && data.message) msg = `⚠️ ${data.message}`;
            } catch {}
            alert(msg);
          }
        } catch (err) {
    ...
    >
      ...
      <button
        type="submit"
        className="px-8 py-3 rounded-full bg-gradient-to-r from-purple-500 to-pink-600 text-white font-semibold shadow-lg w-full md:w-auto"
      >
        🚀 Join the Waitlist
      </button>
    </form>
